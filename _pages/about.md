...
title: about
permalink: /
subtitle: Mathematics & Computer Science @ Hope College

profile:
  align: right
  image: profile_picture_WS.JPG
  image_circular: false # crops the image to make it circular
  more_info: >
    <p>Holland, Michigan</p>

selected_papers: true # includes a list of papers marked as "selected={true}"
social: false # includes social icons at the bottom of the page (disabled due to jekyll-socials v0.0.6 bug)
