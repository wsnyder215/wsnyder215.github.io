...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Brief Overview of experience and skills.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-latex-pretext-converter",
          title: 'LaTeX → PreTeXt Converter',
          description: "A tool for converting LaTeX documents to PreTeXt markup format.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/latex_pretext_converter/";
            },},{id: "projects-llm-personality-stability-experiment",
          title: 'LLM Personality Stability Experiment',
          description: "Investigating consistency and stability in language model behavior across varying contexts and prompts.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/llm_personality_stability/";
            },},{id: "projects-modeling-long-term-seed-viability-with-survival-analysis",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/seed_viability_survival_analysis/";
            },},{id: "projects-mapping-post-traumatic-neuroregeneration-in-the-zebrafish-olfactory-system",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/zebrafish_neuroregeneration/";
